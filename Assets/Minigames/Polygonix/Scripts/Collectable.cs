...
public class Collectable : MonoBehaviour
{
	...
	void Awake()
	{
		...
		polygonPainter = (PolygonPainter)FindObjectOfType(typeof(PolygonPainter));
	}
	...
	void UpdatePosition()
	{
		...
		if (Position.x - spriteRenderer.bounds.extents.x > viewportBottomRight.x)
		{
			Position.x = viewportTopLeft.x - spriteRenderer.bounds.extents.x;
		}
		else if (Position.x + spriteRenderer.bounds.extents.x < viewportTopLeft.x)
		{
			Position.x = viewportBottomRight.x + spriteRenderer.bounds.extents.x;
		}

		if (Position.y - spriteRenderer.bounds.extents.y > viewportTopLeft.y)
		{
			Position.y = viewportBottomRight.y - spriteRenderer.bounds.extents.y;
		}
		else if (Position.y + spriteRenderer.bounds.extents.y < viewportBottomRight.y)
		{
			Position.y = viewportTopLeft.y + spriteRenderer.bounds.extents.y;
		}
